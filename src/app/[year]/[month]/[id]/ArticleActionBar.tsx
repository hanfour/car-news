...
export function ArticleActionBar({ articleId, title, viewCount, commentCount }: ArticleActionBarProps) {
  ...
  const toggleShareMenu = () => {
    ...
    setShowMoreMenu(false) // 關閉其他選單
  }

  const toggleMoreMenu = () => {
    setShowMoreMenu(!showMoreMenu)
    setShowShareMenu(false) // 關閉其他選單
  }
